# robust-secret-sharing     [![Build Status](https://travis-ci.org/michsoch/robust-secret-sharing.svg?branch=master)](https://travis-ci.org/michsoch/robust-secret-sharing)
